...
?>
    ...
    <main class="main--wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="offer-banner offer--banner__bg mb-30" data-background="img/offer/offer__thumb__2.jpg">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="offer-banner offer--banner__bg mb-30" data-background="img/offer/offer__thumb__1.jpg">
                            <div class="offer--banner__text">
        ...
        <div class="offer-deals">
            <div class="offer--deals__main offer-deals--bg pt-75 pb-45" data-background="img/bg/offer__deals__bg.png">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
        ...
        <div class="product pt-60 fix">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="offer-banner offer--banner__bg mb-30" data-background="img/offer/offer__thumb__3.jpg">
                            <div class="offer--banner__text">
                    ...
                    <div class="col-lg-6">
                        <div class="offer-banner offer--banner__bg mb-30" data-background="img/offer/offer__thumb__4.jpg">
                            <div class="offer--banner__text">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="product__single mb-30">
                            <div class="product__box featured__box--item">
                                <div class="product__thumb">
                                    <a href="product-details.html"><img class="img" src="img/allproducts/products__thumb__11.jpg" alt=""></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__single mb-30">
                            <div class="product__box featured__box--item">
                                <div class="product__thumb">
                                    <a href="product-details.html"><img class="img" src="img/allproducts/products__thumb__13.jpg" alt=""></a>
                                </div>
                                <div class="product--flex__right">
                                    <div class="product__content--top">
                                        <span class="cate-name">SAMSUNG</span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__single mb-30">
                            <div class="product__box featured__box--item">
                                <div class="product__thumb">
                                    <a href="product-details.html"><img class="img" src="img/allproducts/products__thumb__15.jpg" alt=""></a>
                                </div>
                                <div class="product--flex__right">
                                    <div class="product__content--top">
                                        <span class="cate-name">SAMSUNG</span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__single mb-30">
                            <div class="product__box featured__box--item">
                                <div class="product__thumb">
                                    <a href="product-details.html"><img class="img" src="img/allproducts/products__thumb__12.jpg" alt=""></a>
                                </div>
                                <div class="product--flex__right">
                                    <div class="product__content--top">
                                        <span class="cate-name">SAMSUNG</span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__single mb-30">
                            <div class="product__box featured__box--item">
                                <div class="product__thumb">
                                    <a href="product-details.html"><img class="img" src="img/allproducts/products__thumb__14.jpg" alt=""></a>
                                </div>
                                <div class="product--flex__right">
                                    <div class="product__content--top">
                                        <span class="cate-name">SAMSUNG</span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__single mb-30">
                            <div class="product__box featured__box--item">
                                <div class="product__thumb">
                                    <a href="product-details.html"><img class="img" src="img/allproducts/products__thumb__16.jpg" alt=""></a>
                                </div>
                                <div class="product--flex__right">
                                    <div class="product__content--top">
                                        <span class="cate-name">SAMSUNG</span>
                    ...
                    <div class="col-sm-12">
                        <div class="offer-banner offer--banner__bg bg-one mb-30 mt-25">
                            <a href="#">
                                <img src="img/offer/offer__thumb__5.jpg" class="img-fluid" alt="">
                    ...
                    <div class="col-xl-3 d-none d-xl-block">
                        <div class="small__banner mb-30">
                            <div class="small__banner--thumb position-relative">
                                <a href="#"><img src="img/offer/offer__small__thumb1.jpg" alt=""></a>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 d-none d-xl-block">
                        <div class="small__banner mb-30">
                            <div class="small__banner--thumb position-relative">
                                <a href="#"><img src="img/offer/offer__small__thumb2.jpg" alt=""></a>
                                <div class="small__banner--content text-center">
                                    <span class="f-300 white-color">Table Lamp</span>
                                    <h2 class="f-800 white-color">60% Flate</h2>
                                </div>
